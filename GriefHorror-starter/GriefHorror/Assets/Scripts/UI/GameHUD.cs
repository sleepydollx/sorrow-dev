...
namespace GriefHorror.UI
{
    public class GameHUD : MonoBehaviour
    {
        ...
        private RectTransform _marksParent;
        ...
        private void UpdatePrompt()
        {
            ...
            // QueryTriggerInteraction.Ignore: trigger volumes (audio zones,
            // atmosphere rooms) should never catch the interaction ray.
        ...
        private void RefreshMarks()
        {
            ...
            if (GameManager.Instance != null)
            {
                // Floor, not round: a mark only lights up once that truth is
                // fully faced. 2.5/5 progress shows 2 marks, not 3.
                filled = Mathf.FloorToInt(
                    GameManager.Instance.VoicemailProgress * voicemailMarks + 0.001f);
            }
        ...
        private void BuildUI()
        {
            ...
            _marksParent.SetParent(root, false);
            _marksParent.anchorMin = _marksParent.anchorMax = new Vector2(0.5f, 1f);
            _marksParent.pivot = new Vector2(0.5f, 1f);
            _marksParent.anchoredPosition = new Vector2(0f, -70f);
            _marksParent.sizeDelta = Vector2.zero;
        ...
        {
            // Clear any existing marks first, so this is safe to call again
            // if the count ever changes.
            ...
            {
                var mark = NewImage(_marksParent, dimColor);
